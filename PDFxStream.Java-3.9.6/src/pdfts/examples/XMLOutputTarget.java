 ...
 * </p>
 * <p>
 * The full source code for this class is included in every PDFxStream
 * distribution.
 * </p>
 * <p>
 * The aim of this {@link OutputHandler} implementation is to output
 * a valid XML document containing the text extracted from the PDF document,
 * as well as interesting structural information (i.e. where {@link Page} and
 * {@link Block} structures begin and end), as well as what text ranges are
...
public class XMLOutputTarget extends OutputHandler {
    ...
    public static void main (String[] args) throws Exception {
        for (int i = 0; i < args.length; i++) {
            ...
            System.out.println("Wrote text extracted from " + args[i] + " to " + destFile.getAbsolutePath() +
